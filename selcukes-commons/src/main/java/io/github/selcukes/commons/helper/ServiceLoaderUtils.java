 ...
 * <p>
 * The function is generic, so it can be used to load any type of service. It uses the Java ServiceLoader to load the
 * service. The ServiceLoader is a Java class that loads services from a file called META-INF/services/<service-type>. The
 * file contains a list of fully qualified class names of the services
 */
@UtilityClass
public class ServiceLoaderUtils {
     ...
     * <p>
     * The function is generic, so it can be used to load any type of service. It uses the Java ServiceLoader to load the
     * service. The ServiceLoader is a Java class that loads services from a file called META-INF/services/<service-type>.
     * The file contains a list of fully qualified class names of the services
     *
     ...
     * <p>
     * The first thing to notice is that the function is generic. This is because the function is designed to work with any
     * type of service
     *
     * @param type        The type of the service to load.
     * @param classLoader The class loader to use for loading the service.
