...
public class CustomTestNGTestListener implements ITestListener {
    private static final Logger LOGGER = Logger.getLogger(CustomTestNGTestListener.class.getName());
